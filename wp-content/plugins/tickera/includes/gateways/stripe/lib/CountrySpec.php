 ...
 * @property \TCStripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \TCStripe\StripeObject $verification_fields
 */
