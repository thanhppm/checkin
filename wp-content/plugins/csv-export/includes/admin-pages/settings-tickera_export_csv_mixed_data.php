                ...
                <div class="inside">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <?php $wp_events_search = new TC_Events_Search( '', '', -1 ); ?>
                            ...
                            <td>
                                ...
                                if ( isset( $tc_export_csv_ticket_type_data ) && '' != $tc_export_csv_ticket_type_data ) :
                                    ...
                                    $ticket_type = get_posts( array (
                                            'post_type' => ( 'product' == $post_type->post_type ) ? 'product' : 'tc_tickets',
                                            'post_status' => 'publish',
                                            'meta_key' => ( 'product' == $post_type->post_type ) ? '_event_name' : 'event_name',
                                ...
                                <fieldset>
                                    ...
                                    if ( isset( $settings ) && !empty( $settings ) ) {
                                        ...
                                        foreach ( $all_setting['remember_setting'] as $checkbox_keys => $checkbox_values ) {
                                            if ( 'on' == $checkbox_values || 1 == $checkbox_values )
                                    ...
                                    foreach ($csv_fields as $key => $val) :
                                        $checked = ( in_array( $key, $csv_checked_by_default ) ) ? 'checked="checked"' : '';
                                        ?>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <select name="tc_limit_order_type" id="tc_limit_order_type">
                                    <?php $payment_statuses = apply_filters( 'tc_csv_payment_statuses', array (
                                            'any' => __( 'Any', 'tccsv' ),
