...
abstract class Webhook
{
     ...
     * \TCStripe\SignatureVerificationException if the signature verification
     ...
     * @return \TCStripe\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     * @throws \TCStripe\Error\SignatureVerification if the verification fails.
     */
