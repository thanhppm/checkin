 ...
 * @property null|\TCStripe\StripeObject $address The customer's address.
 ...
 * @property null|\TCStripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \TCStripe\StripeObject $invoice_settings
 ...
 * @property null|\TCStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \TCStripe\Collection $sources The customer's payment sources, if any.
 * @property null|\TCStripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \TCStripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \TCStripe\Customer the updated customer
     */
     ...
     *
     * @return \TCStripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \TCStripe\Exception\ApiErrorException if the request fails
     *
     * @return \TCStripe\CustomerBalanceTransaction
     */
     ...
     * @throws \TCStripe\Exception\ApiErrorException if the request fails
     *
     * @return \TCStripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \TCStripe\Exception\ApiErrorException if the request fails
     *
     * @return \TCStripe\AlipayAccount|\TCStripe\BankAccount|\TCStripe\BitcoinReceiver|\TCStripe\Card|\TCStripe\Source
     */
     ...
     * @throws \TCStripe\Exception\ApiErrorException if the request fails
     *
     * @return \TCStripe\Collection the list of tax ids
     */
