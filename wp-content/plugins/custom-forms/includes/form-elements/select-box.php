...
class tc_select_field_form_element extends TC_Form_Elements {
    ...
    function on_creation() {
        $this->element_title = apply_filters('tc_select_field_form_element_title', __('Select', 'cf'));
    }
...
tc_register_form_element('tc_select_field_form_element', __('Select (Dropdown)', 'cf'));
