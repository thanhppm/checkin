 ...
 * @property null|string|\TCStripe\Customer $customer The ID of the customer for this session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the session unless an existing customer was provided when the session was created.
 ...
 * @property \TCStripe\StripeObject[] $display_items The line items, plans, or SKUs purchased by the customer. Prefer using <code>line_items</code>.
 * @property \TCStripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\TCStripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\TCStripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\TCStripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\TCStripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\TCStripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\TCStripe\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \TCStripe\ApiResource
{
    ...
    use \TCStripe\ApiOperations\NestedResource;
     ...
     *
     * @return \TCStripe\Collection the list of items
     */
