 ...
 * @property null|string|\TCStripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\TCStripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\TCStripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \TCStripe\StripeObject $spending_controls
...
class Card extends \TCStripe\ApiResource
{
     ...
     *
     * @return \TCStripe\Issuing\CardDetails the card details associated with that issuing card
     */
