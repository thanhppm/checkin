...
namespace TCStripe\HttpClient;

use TCStripe\Exception;
use TCStripe\Stripe;
use TCStripe\Util;
...
class CurlClient implements ClientInterface
{
    ...
    /** @var \TCStripe\Util\RandomGenerator */
     ...
     * @param null|\TCStripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\TCStripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\TCStripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
