...
class tc_input_field_form_element extends TC_Form_Elements {
    ...
    function on_creation() {
        global $wp_query;
        $this->element_title = apply_filters('tc_input_field_form_element_title', __('Input Field', 'cf'));
...
tc_register_form_element('tc_input_field_form_element', __('Input Field', 'cf'));
