...
class tc_checkbox_field_form_element extends TC_Form_Elements {
    ...
    function on_creation() {
        $this->element_title = apply_filters('tc_checkbox_field_form_element_title', __('Checkbox (Multichoice)', 'cf'));
    }
...
tc_register_form_element('tc_checkbox_field_form_element', __('Checkbox (Multichoice)', 'cf'));
