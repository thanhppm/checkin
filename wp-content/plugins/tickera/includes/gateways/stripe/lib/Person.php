 ...
 * @property \TCStripe\StripeObject $address
 * @property null|\TCStripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\TCStripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \TCStripe\StripeObject $dob
 ...
 * @property \TCStripe\StripeObject $relationship
 * @property null|\TCStripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \TCStripe\StripeObject $verification
 */
