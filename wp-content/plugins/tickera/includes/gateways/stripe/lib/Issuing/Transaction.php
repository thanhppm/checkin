 ...
 * @property null|string|\TCStripe\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\TCStripe\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\TCStripe\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\TCStripe\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 ...
 * @property null|\TCStripe\StripeObject $purchase_details Additional purchase information that is optionally provided by the merchant.
