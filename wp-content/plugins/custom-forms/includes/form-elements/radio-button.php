...
class tc_radio_field_form_element extends TC_Form_Elements {
    ...
    function on_creation() {
        $this->element_title = apply_filters('tc_radio_field_form_element_title', __('Radio (Single Choice)', 'cf'));
    }
...
tc_register_form_element('tc_radio_field_form_element', __('Radio (Single Choice)', 'cf'));
