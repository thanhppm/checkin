 ...
 * @property \TCStripe\StripeObject $bacs_debit
 ...
 * @property null|string|\TCStripe\Customer $customer The ID of the Customer to which this PaymentMethod is saved. This will not be set when the PaymentMethod has not been saved to a Customer.
 * @property \TCStripe\StripeObject $eps
 * @property \TCStripe\StripeObject $fpx
 * @property \TCStripe\StripeObject $giropay
 * @property \TCStripe\StripeObject $ideal
 * @property \TCStripe\StripeObject $interac_present
