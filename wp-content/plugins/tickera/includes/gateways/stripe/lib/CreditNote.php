 ...
 * @property string|\TCStripe\Customer $customer ID of the customer.
 * @property null|string|\TCStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \TCStripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\TCStripe\Invoice $invoice ID of the invoice.
 * @property \TCStripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\TCStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \TCStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \TCStripe\CreditNote the previewed credit note
     */
     ...
     * @throws \TCStripe\Exception\ApiErrorException if the request fails
     *
     * @return \TCStripe\Collection the list of credit note line items
     */
